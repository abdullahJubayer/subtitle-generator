...
ENGLISH_GRAMMAR_SYSTEM_PROMPT = (
    ...
    "DO NOT alter segment IDs or change the total number of segments. Return valid JSON matching the schema strictly."
)
...
NATURAL_TRANSLATION_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "Your goal is to translate and adapt the input subtitle segments into natural, fluent, modern spoken {target_language} "
    ...
    "4. CRITICAL CONSTRAINT: DO NOT change, split, merge, or omit segment IDs. Keep the exact same total number of segments."
)
